...
global path "C:\Users\buca4591\Desktop\2nd year\applied\busra_canci\task1\AK91"
...
cd "$path"
	...
	** Col 2 4 6 8 (IV 2SLS) ***
	...
	#d;
	esttab a1 a2 a3 a4 a5 a6 a7 a8 using "$outputpath/TableVI.tex", order(EDUC RACE SMSA MARRIED AGEQ AGEQSQ) 
